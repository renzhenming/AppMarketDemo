...
public class CodecInputSurface {
    ...
    private void eglSetup() {
        if (!Thread.currentThread().getName().equals("UnityMain")) {
            //very important! to get unity eglContext by eglGetCurrentContext
        ...
        mEGLContext = EGL14.eglCreateContext(mEGLDisplay, configs[0], EGL14.eglGetCurrentContext()/*EGL14.EGL_NO_CONTEXT*/,
                attrib_list, 0);
