...
import com.rzm.commonlibrary.general.videoeditor.filter.filter.CameraFilter;
...
import com.rzm.commonlibrary.general.videoeditor.filter.filter.WaterMarkFilter;
import com.rzm.commonlibrary.general.videoeditor.recorder.video.TextureMovieEncoder;
...
//    private MagicAntiqueFilter mBeautyFilter;
    ...
    public CameraDrawer(Context context, Resources resources){
        //初始化一个滤镜 也可以叫控制器
...
//        mBeautyFilter = new MagicAntiqueFilter();
        ...
        waterMarkFilter.setWaterMark(BitmapFactory.decodeResource(resources, R.drawable.watermark));
