...
package com.rzm.commonlibrary.general.videoeditor.recorder.video;
...
import com.rzm.commonlibrary.general.videoeditor.filter.basefilter.MagicCameraInputFilter;
...
import com.rzm.commonlibrary.general.videoeditor.recorder.gles.EglCore;
...
public class TextureMovieEncoder implements Runnable {
    ...
    private void handleUpdateSharedContext(EGLContext newSharedContext) {
        ...
        mInput = new MagicCameraInputFilter(mContext);
        mInput.init();
        filter =null;
        if(filter != null){
            filter.init();
...
//            type = MagicFilterType.NONE;
    ...
    private AFilter mShowFilter=new NoFilter(mContext.getResources());
