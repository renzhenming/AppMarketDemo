package com.rzm.commonlibrary.general.videoeditor.filter.basefilter;
...
public class MagicCameraInputFilter extends GPUImageFilter{
    ...
    public MagicCameraInputFilter(Context context){
        super(GLUtils.readShaderFromRawResource(context, R.raw.default_vertex) ,
                GLUtils.readShaderFromRawResource(context,R.raw.default_fragment));
    }
