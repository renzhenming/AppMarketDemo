...
import com.rzm.commonlibrary.general.videoeditor.utils.PathUtils;
...
public class AudioCodec {
    ...
    public static void audioMix(Context context, String audioPathOne, String audioPathTwo, final String outPath, final AudioDecodeListener listener){
        final String path = PathUtils.getPath(context,"audio/outputPCM/", "PCM_"+ System.currentTimeMillis()+".pcm");
        ...
        final String path2 = PathUtils.getPath(context,"audio/outputPCM/", "PCM_"+ System.currentTimeMillis()+".pcm");
