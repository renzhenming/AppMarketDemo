...
public class StackManager implements CloseFragment {
     ...
     */
    public void setFragment(@NonNull BaseFragment mTargetFragment) {
     ...
     */
    public void addFragment(BaseFragment from, BaseFragment to, Bundle bundle, @StackMode int stackMode) {
     ...
     * @param to next fragment
     */
    public void openFragment(BaseFragment from, BaseFragment to) {
     ...
     * @param bundle Parameter carrier
     */
    public void addFragment(BaseFragment from, BaseFragment to, Bundle bundle) {
    ...
    @Override
    public void close(final BaseFragment fragment) {
        if (isFirstClose) {
